...
modular Swiss-grid layout with overlapping cards and a diagonal scroll rhythm — geometric grotesque headlines with a single italic serif accent word per section — monochromatic dusty-blue IDE-theme palette (Nord-inspired): #E8ECF1, #B8C4D9, #7C93B3, #46618A, #263447 — crisp, systematic, calmly confident
